var $addFileLink = $('<div class="col-lg-4"> <button href="#" id="btn-add-file-element" class="btn btn-purple btn-labeled fa fa-plus" type="button">Ajouter fichier</button></div>');
